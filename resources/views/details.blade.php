...
@section('content')
    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
            ...
            @livewire('product-details-info-component', ['product' => $product])
        </div>
        <div class="row px-xl-5">
            <div class="col">
                <div class="nav nav-tabs justify-content-center border-secondary mb-4">
                    <a class="nav-item nav-link active" data-toggle="tab" href="#tab-pane-1">Description</a>
                    <a class="nav-item nav-link" data-toggle="tab" href="#tab-pane-3">Reviews ({{ $product->countOfCommentaries() }})</a>
                </div>
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-pane-3">
                        @livewire('product-details-commentaries-component', ['product' => $product])
                    </div>
                </div>
            </div>
        </div>

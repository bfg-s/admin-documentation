...
@section('content')
    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5 pb-3">
            @foreach(\Admin\Extend\AdminShopify\Models\ProductCategory::active()->roots()->hasPhotos()->take(6)->withCount('products')->with('seo')->get() as $category)
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        <p class="text-right">{{ $category->products_count }} Products</p>
                        <a href="{{ route('shop', $category->seo->slug) }}" class="cat-img position-relative overflow-hidden mb-3">
                            <img class="img-fluid" style="height: 300px" src="{{ asset($category->photo) }}" alt="">
                        </a>
